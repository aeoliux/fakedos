...
ivt_setup:
    ...
    ; 0x20 is DOS exit
    mov bx, exit
    mov word [es:0x0 + (0x20 * 4) + 0x0],   bx
    mov word [es:0x0 + (0x20 * 4) + 0x2],   ax
...
ivt_handler:
    ; exit must be handled immediately, we can't touch stack
    cmp ah, 0x4c
    je exit
...
ivt_handlers:
a000:	dw		0x0,			    0x0
a0x1:	dw		read_char,			0x1000
a0x2:	dw		print_char,			0x1000
a0x3:	dw		0x0,				0x0
a0x4:	dw		0x0,				0x0
a0x5:	dw		0x0,				0x0
a0x6:	dw		0x0,				0x0
a0x7:	dw		read_char_no_echo,  0x1000
a0x8:	dw		read_char_no_echo,  0x1000
a0x9:	dw		display_string,		0x1000
a0xa:	dw		keyboard_input,		0x1000
a0xb:	dw		0x0,				0x0
a0xc:	dw		0x0,				0x0
a0xd:	dw		0x0,				0x0
a0xe:	dw		0x0,				0x0
...
a0x40:	dw		0x0,				0x0
a0x41:	dw		0x0,				0x0
a0x42:	dw		move_pointer,		0x1000
a0x43:	dw		0x0,				0x0
a0x44:	dw		0x0,				0x0
a0x45:	dw		0x0,				0x0
a0x46:	dw		0x0,				0x0
a0x47:	dw		0x0,				0x0
a0x48:	dw		allocate_blocks,	0x1000
a0x49:	dw		deallocate_blocks,  0x1000
a0x4a:	dw		0x0,				0x0
a0x4b:	dw		execute,			0x1000
a0x4c:	dw		0x0,				0x0
a0x4d:	dw		0x0,				0x0
a0x4e:	dw		0x0,				0x0
a0x4f:	dw		0x0,				0x0
